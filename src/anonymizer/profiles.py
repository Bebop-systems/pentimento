...
Novelty profiles keep that rule. They are absurd about *which* camera they
claim, never about internal consistency, and their numeric fields stay real
numbers so a written file still passes all four gates. The comedy lives in
the text fields; the optics stay arithmetic.
"""
...
_NOVELTY = [
    ...
    CameraProfile(
        ...
        novelty=True,
        note="Hubble really is a 57.6 metre focal length at f/24. The claim "
             "that it was pointed at your kitchen is the implausible part.",
    ),
]
